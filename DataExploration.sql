...
SELECT *FROM [DataExploration].[dbo].[Revenue_Raw_Data]
SELECT *FROM [DataExploration].[dbo].[ipi_account_lookup]
SELECT *FROM [DataExploration].[dbo].[ipi_Calendar_lookup]
SELECT *FROM [DataExploration].[dbo].[Targets_Raw_Data]
